<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"template/config\formConfig.html";i:1515834951;s:28:"template/default_layout.html";i:1516254445;s:22:"template/leftmenu.html";i:1515741435;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <ul id="nav">
      ...
      <li class="has_sub "><a href="#" class="subdrop"><i class="icon-bar-chart"></i>项目配置</a>
        <ul style="display: block;">
          <li><a href="<?php echo APP_NAME; ?>/Config/index">项目配置</a></li>
          <li><a href="<?php echo APP_NAME; ?>/Config/formConfig">表单配置</a></li>
        </ul>
      </li>
