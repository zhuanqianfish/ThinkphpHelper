<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:40:"codeRepository\default/View/getList.html";i:1524044657;}*/ ?>
{extend name="layout" /}
{block name="content"}
<div class="container">
<div class="row">
...
<?php endforeach; endif; else: echo "" ;endif; ?>
<td><a href="{:url('<?php echo $moduleName; ?>/<?php echo $tableName; ?>/edit', ['id'=>$vo['id']])}">编辑</a> |
<a href="{:url('<?php echo $moduleName; ?>/<?php echo $tableName; ?>/delete', ['id'=>$vo['id']])}" onclick='return confirm("确定删除吗？")'>删除</a>
</td>
<tr>
{/volist}
</table>
