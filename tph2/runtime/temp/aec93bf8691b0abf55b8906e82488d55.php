<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"codeRepository\default/View/menu.html";i:1515661286;}*/ ?>
{block name="content"}
...
<?php if(is_array($menuList) || $menuList instanceof \think\Collection || $menuList instanceof \think\Paginator): $i = 0; $__LIST__ = $menuList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menuItem): $mod = ($i % 2 );++$i;?>
	...
	<ul>
		<li><a href="{:Request::instance()->module()}/<?php echo tableNameToModelName($menuItem); ?>/list">管理</a></li>
